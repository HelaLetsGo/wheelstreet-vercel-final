...
CREATE TABLE IF NOT EXISTS service_tabs (
  ...
  full_desc TEXT,
  icon VARCHAR,
  display_order INTEGER, -- Changed from 'order' to 'display_order' to avoid reserved keyword
...
INSERT INTO service_tabs (section_id, tab_id, title, short_desc, full_desc, icon, display_order, is_active, benefits)
VALUES 
